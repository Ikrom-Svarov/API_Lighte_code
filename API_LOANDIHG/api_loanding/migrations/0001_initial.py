# Generated by Django 4.1.6 on 2023-05-30 09:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='api_loanding.section')),
            ],
            options={
                'verbose_name': 'Раздел',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studying_time', models.ManyToManyField(to='api_loanding.studyingtime', verbose_name='Время обучения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_loanding.section', verbose_name='Раздел')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(null=True, unique=True)),
                ('created_date', models.DateField(auto_now_add=True, verbose_name='Дата создания')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_loanding.section', verbose_name='Курс')),
