...
class Student(models.Model):
    ...
    # studying_time  = models.ForeignKey(StudyingTime, on_delete=models.CASCADE, verbose_name='Время обучения', blank=True, null=True)
...
class Income(models.Model):
    ...
    slug = models.SlugField(unique=True, null=True)
    course = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name='Kурс', null= True)
    value = models.DecimalField(decimal_places=2, max_digits=12, default=0.00, verbose_name='Цена')
